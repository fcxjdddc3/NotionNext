...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.quilled-slipper-e5e.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '请努力活着！', // 作者简介
