...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '枇哩杷啦', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '每天都在吃馒头', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://loquatee.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '枇杷, 博客', // 网站关键词 英文逗号隔开
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://youtube.com/@ybpp', // Youtube主页
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 5000, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 5000, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
